function [pathOutput,elatime]=RRT_star_informed(map,start,goal,max_iter,step,bias,PATIENCE,ellipse,dyn_plot)
%
% RRT* Algorithm. Informed behaviour can be enabled.
%
%   [pathOutput,elatime]=RRT_star_informed(map,start,goal,max_iter,step,bias,PATIENCE,ellipse,dyn_plot)
%
% Inputs:
...
if cost_best<inf
    ...
    while idx>1
        ...
        pathOutput=[pathOutput; tree(idx,:)];
